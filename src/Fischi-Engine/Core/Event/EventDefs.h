...
namespace FischiEngine 
{
	...
	public:
		...
		WindowResizeEvent(void* windowHandle, uint32_t width, uint32_t height)
			: m_Width(width), m_Height(height), m_WindowHandle(windowHandle) {}
		...
		{
			std::stringstream ss;
			ss << "WindowResizeEvent: " << m_WindowHandle << " (" << m_Width << ", " << m_Height << ")";
			return ss.str();
		}
